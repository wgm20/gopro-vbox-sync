...
Use the download page's **Download for Windows** button. No Python installation, payment, activation or GitHub account is needed. A portable ZIP is also available on the [releases page](https://github.com/wgm20/gopro-vbox-sync/releases/tag/v1.4.0b4): extract the entire folder before opening GoProVBOXSync.exe.
